...
pub fn MinHeap(comptime T: type) type {
    return struct {
        ...
        pub fn ensure_capacity(self: *Self, requested_capacity: usize) !void {
        ...
        pub fn heapify_down(self: *Self, idx: usize) void {
        ...
        pub fn heapify_up(self: *Self, idx: usize) void {
            if (idx == 0) return;
...
test "min heap: insert values & remove all values in correct order" {
    ...
    var min_heap: MinHeap(i32) = MinHeap(i32).init(allocator);
